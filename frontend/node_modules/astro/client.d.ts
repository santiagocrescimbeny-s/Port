...
declare module 'astro:assets' {
	...
	export const getConfiguredImageService: typeof import('astro/assets').getConfiguredImageService;
	export const inferRemoteSize: typeof import('astro/assets/utils').inferRemoteSize;
	export const Image: typeof import('astro/components/Image.d.astro.js').default;
	export const Picture: typeof import('astro/components/Picture.d.astro.js').default;
	export const Font: typeof import('astro/components/Font.d.astro.js').default;
	export const fontData: Record<
		import('astro:assets').CssVariable,
		Array<import('astro:assets').FontData>
	>;
	export const experimental_getFontFileURL: typeof import('astro/assets/fonts/runtime.js').experimental_getFontFileURL;
...
declare module 'astro:static-paths' {
	export const StaticPaths: typeof import('astro/runtime/prerender/static-paths.js').StaticPaths;
}
