...
import type { ComponentSlots } from 'astro/runtime/server/render/slot.js';
import type { AstroComponentFactory, AstroFactoryReturnValue } from 'astro/runtime/server/render/astro/factory.js';
