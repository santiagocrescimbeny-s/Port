...
export type { ServerIslandComponent } from 'astro/runtime/server/render/server-islands.js';
export { templateEnter, templateExit } from 'astro/runtime/server/render/template-depth.js';
